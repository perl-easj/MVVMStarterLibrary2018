...
namespace Extensions.Model.Implementation
{
    ...
    /// </summary>
    public abstract class FilePersistableCatalogAsync<TDomainData, TViewData, TPersistentData> : PersistableCatalogAsync<TDomainData, TViewData, TPersistentData>
        where TDomainData : class, IStorable
        where TViewData : IStorable
    {
        protected FilePersistableCatalogAsync(bool saveOnChanges = false)
